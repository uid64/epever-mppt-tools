...
BATTERY_TEMPERATURE_COMPENSATION_COEFFICIENT = 0
BATTERY_OVERVOLTAGE_DISCONNECT_VOLTAGE = 5840 #(=3.65V/cell)
BATTERY_CHARGING_LIMIT_VOLTAGE = 5760 #(=3.6V/cell)
BATTERY_OVERVOLTAGE_RECONNECT_VOLTAGE = 5616 #(=3.51V/cell)
BATTERY_EQUALIZATION_VOLTAGE = 5440 #(=3.40V/cell)
BATTERY_BOOST_VOLTAGE = 5440 #(=3.40V/cell)
BATTERY_FLOAT_VOLTAGE = 5392 #(=3.37V/cell)
